...
exports.default = function (target) {
  ...
  target.prototype.globalHide = function (event) {
    if (this.mount) {
      ...
      this.hideTooltip({ currentTarget: hasTarget && event.detail.target }, hasTarget, this.props.forceHideOnEscape);
    }
  };
};
...
var ReactTooltip = (0, _staticMethods2.default)(_class = (0, _windowListener2.default)(_class = (0, _customEvent2.default)(_class = (0, _isCapture2.default)(_class = (0, _getEffect2.default)(_class = (0, _trackRemoval2.default)(_class = (_temp = _class2 = function (_React$Component) {
  ...
  _createClass(ReactTooltip, [{
    ...
    key: 'bindKeyUpEventListener',
    value: function bindKeyUpEventListener() {
      var isCapture = this.props.isCapture;

      window.removeEventListener('keyup', this.handleKeyUp);
      window.addEventListener('keyup', this.handleKeyUp, isCapture);
    }
  }, {
    key: 'unbindKeyUpEventListener',
    value: function unbindKeyUpEventListener() {
      window.removeEventListener('keyup', this.handleKeyUp);
    }
  }, {
    ...
    * If we're mousing over the tooltip remove it when we leave.
    ...
    value: function hideTooltip(e, hasTarget, forceHide) {
      ...
      var resetState = function resetState() {
        ...
        // Check if the mouse is actually over the tooltip, if so don't hide the tooltip
        if (!forceHide && !_this6.props.ignoreMouseOverOnHide && _this6.mouseOnToolTip()) {
